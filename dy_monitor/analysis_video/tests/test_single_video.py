...
def fetch_single_video(share_url: str):
    ...
    try:
        response = requests.get(f"{BASE_URL}/api/v1/douyin/app/v3/fetch_one_video_by_share_url", headers=headers, params=params)
...
if __name__ == "__main__":
    # 示例用法
    share_url = "https://v.douyin.com/xEm7dENmRdQ/"
